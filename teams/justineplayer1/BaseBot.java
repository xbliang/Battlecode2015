...
public class BaseBot {
	...
	public static final int swarm = 1000;
	...
	private void transferSupplies() throws GameActionException {
		...
		for(RobotInfo ri:nearbyAllies){
			if (ri.type == RobotType.DRONE && (rc.getType() == RobotType.HQ || rc.getType() == RobotType.BARRACKS ||
					rc.getType() == RobotType.MINERFACTORY || rc.getType() == RobotType.TANKFACTORY || 
					rc.getType() == RobotType.SUPPLYDEPOT)){
